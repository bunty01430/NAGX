...
impl TerminalEmulator {
    ...
    pub fn process(&mut self, bytes: &[u8]) -> slint::StyledText {
    ...
    fn render_styled(&self) -> slint::StyledText {
        ...
        slint::StyledText::from_markdown(&markup)
            .unwrap_or_else(|_| slint::StyledText::from_plain_text(&screen.contents()))
    }
}
